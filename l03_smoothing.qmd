...
In R, it is enough to have *one* variable representing the seasons. This categorical variable should be saved as `factor`. Then we apply the OLS method to find the model coefficients (see results in @fig-airpassangersRegTrendSeas):
